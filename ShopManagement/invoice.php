    ...
    <div class="invoice-container">
        <div class="invoice-header">
            <div class="title-date">
                <h2 class="title"><input type="text" name="text" class="unit color-same-inpt" placeholder="INVOICE NAME"></h2>
                <p class="date"><input type="text" name="text" class="unit color-same-inpt" placeholder="01/01/2024"></p>
            </div>
            <div class="space"></div>
            <p class="invoice-number"><input type="text" name="text" class="unit color-same-inpt" placeholder="#301244"></p>
        </div>
...
overallSum =()=> {
    ...
    for(var i = 0; i < arr.length; i++) {
        ...
        document.getElementById("total").value = total + "DA";
    }
}
...
console.log("This designe of INVOICE i take it from '@Panshak Solomon' From GITHUB and am Abderlrahmen who write this")
</script>
